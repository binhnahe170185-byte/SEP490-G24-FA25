...
import '../../createSchedule/CreateSchedule.css';
import { filterSemestersForEdit } from '../../createSchedule/utils/semesterFilter';
            ...
            try {
                ...
                if (data) {
                    ...
                    if (data.semesters && Array.isArray(data.semesters)) {
                        ...
                        // Apply filter for EDIT mode: show current and future semesters
                        const formattedSemesters = filterSemestersForEdit(allSemesters);
