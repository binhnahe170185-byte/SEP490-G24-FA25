...
public class FeedbackService : IFeedbackService
{
        ...
        GeminiFeedbackAnalyzer geminiAnalyzer)
    {
        ...
        try
        {
            ...
            var answers = feedback.GetAnswersDict();
            ...
            try
            {
                ...
                logger?.LogInformation("Keywords saved successfully");
            }
            catch (Exception ex)
            {
                logger?.LogError(ex, "Failed to save keywords to feedback");
            }
            ...
            try
            {
                ...
                logger?.LogInformation("Suggestions saved successfully");
            }
            catch (Exception ex)
            {
                logger?.LogError(ex, "Failed to save suggestions to feedback");
            }
            ...
            var reloadedKeywords = feedback.GetKeywordsList();
            var reloadedSuggestions = feedback.GetAiSuggestionsList();
    ...
    private async Task<FeedbackDto> MapToDtoAsync(Feedback feedback)
    {
        ...
        return new FeedbackDto(
            ...
            feedback.GetKeywordsList(),
            feedback.GetAiSuggestionsList(),
            feedback.Urgency,
            feedback.MainIssue,
